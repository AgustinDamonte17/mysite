...
export const ui = {
  es: {
    ...
    homeIntro: 'Bienvenidos a mi blog. Acá publicaré mis ideas y proyectos personales/laborales. Soy desarrollador en Quantum América, co-fundador y socio de Iris Energía. Actualmente estoy principalmente construyendo con IA.',
    seeAll: 'Ver todos',
  },
  en: {
    home: 'Home',
    ...
    homeIntro: 'Welcome to my blog. Here I\'ll publish my personal and work ideas and projects. I\'m a developer at Quantum América, co-founder and partner at Iris Energía. Right now I\'m mainly building with AI.',
    seeAll: 'See all',
  },
} as const;
